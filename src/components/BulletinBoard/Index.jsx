...
function Spotlight() {
  ...
  // Update board width on resize with debouncing
  useEffect(() => {
  ...
  const handlePinnedCardMouseDown = useCallback((e, cardId) => {
  ...
  }, [handleCardMouseDown, pinnedCards]);
  ...
  const handleAddCard = useCallback(() => {
    ...
    if (newCard && boardRef.current) {
      ...
      // Batch state updates together using RAF
      requestAnimationFrame(() => {
        setCardPositions(prev => ({
          ...prev,
  ...
  }, [updateCardRotations, cards, pinnedCards, setCardPositions]);
