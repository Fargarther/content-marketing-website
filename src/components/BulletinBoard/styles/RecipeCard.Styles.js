...
export const CardContainer = styled.div`
  ...
  left: 0;
  top: 0;
  --card-x: ${props => `${props.$x}px`};
  --card-y: ${props => `${props.$y}px`};
  ...
  @keyframes cardPulse {
    0% {
      transform: translate3d(var(--card-x), var(--card-y), 0) scale(0) rotate(var(--card-rotate));
      opacity: 0;
    }
    50% {
      transform: translate3d(var(--card-x), var(--card-y), 0) scale(1.1) rotate(var(--card-rotate));
    }
    100% {
      transform: translate3d(var(--card-x), var(--card-y), 0) scale(1) rotate(var(--card-rotate));
      opacity: 1;
    }
  }
`;
